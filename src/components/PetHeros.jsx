...
const petHeroes = [
  ...
  },
  {
    ...
    role: "Adopter",
    image:
      "https://images.unsplash.com/photo-1525253086316-d0c936c814f8?auto=format&fit=crop&w=500&q=80",
  },
  {
    name: "Sophie Lee",
    role: "Pet Volunteer",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          {petHeroes.map((hero, index) => (
            <div
              key={index}
              className="card bg-gradient-to-r from-orange-50 via-pink-50 to-purple-50 shadow-lg rounded-2xl overflow-hidden text-center p-4"
            >
              <img
                src={hero.image}
                alt={hero.name}
